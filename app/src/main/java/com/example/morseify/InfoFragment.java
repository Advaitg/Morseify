...
public class InfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] infoArray = getResources().getStringArray(R.array.InfoString);
        TextView textView = (TextView) mView.findViewById(R.id.textView1);
        TextView textView2;
        TextView textView3;
        textView.setText(String.valueOf(infoArray[0]));
        textView2 = (TextView) mView.findViewById(R.id.textView2);
        textView2.setText(String.valueOf(infoArray[1]));
        textView3 = (TextView) mView.findViewById(R.id.textView3);
        textView3.setText(String.valueOf(infoArray[2]));
        return mView;
    }
}